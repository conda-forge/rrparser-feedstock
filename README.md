...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rrparser-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14083&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rrparser-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rrparser` can be installed with:

```
conda install rrparser
```

It is possible to list all of the versions of `rrparser` available on your platform with:
